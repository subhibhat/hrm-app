...
export default function LoginForm({ onSubmit, loading }: LoginForm) {
	...
	return (
		<form onSubmit={handleSubmit} className=" flex w-[427px] p-[30px] flex-col items-start gap-[38px] self-stretch ">
			...
			<div className=" flex w-full flex-col items-start gap-5 self-stretch ">
				<label className=" flex flex-col items-start gap-2 self-stretch ">
					...
					<div className=" flex h-[44px] py-0 px-3.5 items-center gap-2.5 self-stretch rounded-lg border-[1px] border-solid border-[var(--border)] ">
						...
						<input type="email" onChange={(e) => setUsername(e.target.value)} placeholder="example@email.com" className=" flex w-full h-full px-0 py-3.5 items-center gap-2.5 self-stretch focus:outline-none " />
					</div>
				</label>
				<label className=" flex flex-col items-start gap-2 self-stretch ">
					<span>รหัสผ่าน</span>
					<div className=" flex h-[44px] py-0 px-3.5 items-center gap-2.5 self-stretch rounded-lg border-[1px] border-solid border-[var(--border)] ">
						...
						<input type="password" onChange={(e) => setPassword(e.target.value)} className=" flex w-full h-full px-0 py-3.5 items-center gap-2.5 self-stretch focus:outline-none " />
			...
			<button disabled={loading} type="submit" className=" flex w-full h-[44px] justify-center items-center gap-2.5 self-stretch rounded-lg bg-[var(--primary)] text-[var(--primary-foreground)] disabled:opacity-50 disabled:cursor-not-allowed ">เข้าสู่ระบบ</button>
		</form>
	)
}