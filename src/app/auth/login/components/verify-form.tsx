	...
	return (
		<form onSubmit={onSubmit} className=" flex w-full flex-col items-start gap-5 self-stretch ">
			...
			<div className=" flex w-full flex-col items-start gap-5 self-stretch ">
				<label className=" flex flex-col items-start gap-2 self-stretch ">
					<div className=" flex justify-between items-center self-stretch">
						<span className=" font-medium leading-[110%]">Select MFA Method</span>
						<div className=" flex justify-center items-center gap-1 ">
							...
							<span className=" text-[var(--primary)] ">Send Code</span>
						</div>
					</div>
					<div className=" flex h-[44px] py-0 px-3.5 items-center gap-2.5 self-stretch rounded-lg border-[1px] border-solid border-[var(--border)] ">
						...
						<div className=" w-full text-[var(--text-secondary)] ">Email</div>
			...
			<div className=" flex w-full flex-col gap-5 self-stretch">
				<button className=" flex w-full h-[44px] justify-center items-center gap-2.5 self-stretch rounded-lg bg-[var(--primary)] text-[var(--primary-foreground)] " type="submit">Verify</button>
				<div className=" flex justify-center items-center gap-2.5 self-stretch">
					...
					<div className=" text-[var(--text-secondary)] font-medium leading-normal not-italic " onClick={() => setShowMfa(false)}>Back to Login</div>
				</div>
			</div>
		</form>
	)
